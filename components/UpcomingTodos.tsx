...
const UpcomingTodos = () => {
  ...
  return (
    <div className="mt-6">
      ...
      <div className="rounded-lg border dark:border-neutral-500 py-2 pt-0 bg-white shadow-sm max-h-[300px] overflow-auto ">
        <table className="w-full bg-white text-black/75 dark:bg-neutral-800 dark:text-neutral-300 text-sm relative">
          <thead className="border-b dark:border-b-neutral-500 bg-gray-100 dark:bg-neutral-700 sticky top-0 ">
            <tr className=" border-b dark:border-b-neutral-500">
              ...
              <th className="text-right py-2 text-gray-500/50 dark:text-neutral-500 font-normal px-2 pr-6">
                Project
              </th>
            </tr>
          </thead>
